...
return [
  ...
  /*
    ...
    |--------------------------------------------------------------------------
    |
    | When your application supports teams, Access Control will automatically detect
  ...
  /*
    ...
    |--------------------------------------------------------------------------
    |
    | When enabled, Access Control will create a basic panel user role that can be
  ...
  /*
    ...
    | preferred naming convention and organizational standards. Access Control uses
  ...
  /*
    ...
    |--------------------------------------------------------------------------
    |
    | Access Control can automatically generate Laravel policies for your resources.
  ...
  /*
    ...
    |--------------------------------------------------------------------------
    |
    | Access Control supports multiple languages out of the box. When enabled, you
  ...
  'localization' => [
    'enabled' => false,
    'key' => 'filament-access-control::filament-access-control',
  ],
  ...
  'resources' => [
    'subject' => 'model',
    'manage' => [
      \Webkernel\Application::class => ['viewAny', 'view', 'create', 'update', 'delete'],
    ],
    'exclude' => [
      //
    ],
  ...
  /*
    ...
    |--------------------------------------------------------------------------
    |
    | By default, Access Control only looks for entities in your default Filament
    | panel. Enable these options if you're using multiple panels and want
    | Access Control to discover entities across all of them.
    |
    */
  ...
  /*
    ...
    |--------------------------------------------------------------------------
    |
    | Access Control can automatically register a policy for role management itself.
