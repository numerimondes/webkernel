        ...
        FilamentView::registerRenderHook(
            ...
            function () {
                ...
                ">
                    ...
                    <span class="powered-by-container text-sm font-medium leading-6 text-gray-950 dark:text-white" style="margin-left: 3px; margin-right: 3px;">
                        {$poweredByText}
                    </span>
                    <img src="{$logo}" alt="Logo"
                    style="width: {$img_width}px; height: auto; display: inline-block; vertical-align: middle; margin-right: 2px;">
                    <strong class="text-sm font-bold leading-6 text-gray-950 dark:text-white">{$brand}</strong>
                    <span class="powered-by-container" style="margin-left: 3px; margin-right: 3px; color: #000;">
                    <a href="{$poweredLinkBrand}" target="_blank" rel="noopener noreferrer"
                        style="color: currentColor; text-decoration: none;">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 {$svg_width} {$svg_width}" stroke-width="{1.5}" stroke="currentColor" class="size-6">
                ...
                <!-- Help Bouton menu déplacé ici -->
                <button type="button" id="radix-«r6»" aria-haspopup="menu" aria-expanded="false" data-state="closed"
                    class="flex items-center justify-center rounded-full border border-default bg-default p-1 text-muted shadow-xl transition-colors hover:bg-muted focus-visible:outline-hidden dark:border-transparent">
