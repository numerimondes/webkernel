...
//packages/webkernel/src/Console/Package/CheckUpdate.php
...
class CheckUpdate extends Command
{
    ...
    public function handle()
    {
        ...
        $remoteRepo = $this->option('remote-repo') ?? WEBKERNEL_REMOTE_PACKAGES_PATH;
    ...
    private function fetchRemotePackages(string $remoteRepo): array
    {
        ...
        $url = rtrim($remoteRepo, '/') . '/raw/main/' . WEBKERNEL_REMOTE_PACKAGES_PATH;
