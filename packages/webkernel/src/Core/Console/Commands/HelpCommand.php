...
class HelpCommand extends Command
{
    ...
    {
        $directories = [
            base_path(WEBKERNEL_VIEWS_BASE_PATH . '/components'),
            base_path(WEBKERNEL_VIEWS_BASE_PATH . '/filament')
        ];
    ...
    protected function generateComponent ($componentType, $section, $role, $complexity, $fileType, $componentName)
    {
        ...
        $basePath = base_path(WEBKERNEL_VIEWS_BASE_PATH);
...
protected function displaySummary()
{
    ...
    if ($lastLine) {
        ...
        $this->line("No components \033]8;;" . WEBKERNEL_DEFAULT_ISSUES_LINK . "\033\\Please report this issue on GitHub!\033]8;;\033\\.");
        $this->line(str_repeat('-' . PHP_EOL, 30));
    }
