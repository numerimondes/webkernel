...
use Filament\Pages\Auth\CreateProfile as BaseCreateProfile;
    ...
    public function form(Form $form): Form
    {
        return $form->schema([
            ...
            Section::make(__('Need Help?'))
                ->schema([
                    View::make(view: 'webkernel::components.webkernel.rolebased.common.profile-header')
                    ])
                ->collapsible()
                ->collapsed(false),
                ...
                ->schema([
                    Tabs::make('Profile')
                        ->tabs([
                            ...
                            Tabs\Tab::make(__('Marketing Consent'))
                                ->schema([
