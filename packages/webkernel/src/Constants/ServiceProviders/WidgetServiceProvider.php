...
class WidgetServiceProvider extends ServiceProvider
{
    ...
    {
        $paths = [
            base_path('packages/webkernel/src/Core/Filament/Widgets') => 'Webkernel\\Core\\Filament\\Widgets',
        ];
    ...
    {
        $paths = [
            base_path('packages/webkernel/src/Core/View/Components') => 'Webkernel\\Core\\View\\Components',
        ];
