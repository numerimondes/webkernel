<!DOCTYPE html>
<html lang="fr" x-data="{ darkMode: true }" :class="{ 'dark': darkMode }" class="dark">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>@yield('title', 'Documentation Numerimondes')</title>
    ...
    --f-cursor-text: url(
        ...
        /* Apply other cursor styles for specific interactions */
...
<body class="bg-black text-white antialiased custom-cursor ">
    <!-- Top Navigation -->
        ...
        <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 bg-gradient-to-br from-red-500 to-orange-600 rounded-lg flex items-center justify-center">
                            <x-filament::icon icon="heroicon-o-code-bracket" class="w-5 h-5 text-white" />
                        </div>
                        <span class="text-xl font-bold text-white">Numerimondes</span>
                    </div>
                    <div class="hidden lg:flex items-center space-x-8 ml-8">
                        ...
                        <a href="#" class="text-sm font-medium text-gray-300 hover:text-red-400 transition-colors">Formation</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <!-- Theme Toggle -->
                    <button @click="darkMode = !darkMode" class="p-2 text-gray-400 hover:text-gray-300 rounded-lg transition-colors">
                        <x-filament::icon icon="heroicon-o-sun" class="w-5 h-5" x-show="!darkMode" />
                        <x-filament::icon icon="heroicon-o-moon" class="w-5 h-5" x-show="darkMode" />
                    </button>
                    <!-- GitHub -->
                    <button class="flex items-center space-x-2 px-3 py-2 text-sm text-gray-400 bg-gray-900 border border-gray-700 rounded-lg hover:border-gray-600 transition-colors">
                        <x-filament::icon icon="heroicon-o-code-bracket-square" class="w-4 h-4" />
                        <span>GitHub</span>
                    </button>
                </div>
            </div>
