...
{{-- Prevent flash of unstyled content - inline script must be first --}}
<script>
    // Immediate theme initialization to prevent FOUC
    (function() {
        const savedTheme = localStorage.getItem('theme') || '{{ $defaultTheme ?? 'system' }}';
...
{{-- Filament-inspired Theme System Styles --}}
<style>
...
{{-- Filament-inspired Theme System --}}
<script>
        ...
        document.addEventListener('alpine:init', () => {
            ...
            const availableModes = @js($themeQuery->getTheme() ? $themeQuery->getTheme()->getAvailableModes() : ['light', 'dark']);
    ...
    window.app = {
        ...
        toggleTheme() {
            const currentTheme = localStorage.getItem('theme') || '{{ $defaultTheme ?? 'system' }}';
            let newTheme;
