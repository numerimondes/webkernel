                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            {{ $companyDescription ?? 'Professional website builder with dynamic themes and modern design capabilities.' }}
                        </p>
                                       ...
                                       aria-label="{{ ucfirst($platform) }}">
                                        @switch($platform)
                                            ...
                                            @case('github')
                                                ...
                                                @break
                                            @default
                                                <span class="text-xs">{{ strtoupper($platform) }}</span>
                                        @endswitch
                                    </a>
                                @endforeach
                            </div>
                    ...
                    {{-- Resources --}}
                    @if(isset($footerLinks['resources']))
                        <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                            @if(isset($contactInfo['email']))
                                <p>
                                    <a href="mailto:{{ $contactInfo['email'] }}" class="hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                                        {{ $contactInfo['email'] }}
                                    </a>
                                </p>
                            @endif
                            @if(isset($contactInfo['phone']))
                                <p>
                                    <a href="tel:{{ $contactInfo['phone'] }}" class="hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                                        {{ $contactInfo['phone'] }}
                                    </a>
                                </p>
                            @endif
