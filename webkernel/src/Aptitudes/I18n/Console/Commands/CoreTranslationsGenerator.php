...
namespace Webkernel\Aptitudes\I18n\Console\Commands;
...
class CoreTranslationsGenerator extends Command
{
    /**
    ...
    */
    ...
    private function initializeBasicConfig(): void
    {
        ...
        if (empty($this->baseDir)) {
            $this->baseDir = base_path('webkernel/src/Aptitudes/I18n/Lang');
        }
    ...
    private function initializeConfig()
    {
        ...
        if (empty($this->config)) {
            $packageConfigPath = base_path('webkernel/src/Aptitudes/I18n/Config/webkernel-aptitudes-lang.php');
    ...
    private function selectTargetDirectory()
    {
        ...
        foreach ($moduleLangPaths as $module) {
            ...
            if ($langPath && is_dir($langPath)) {
                ...
                $relativePath = str_replace(base_path() . '/', '', $langPath);
        ...
        if ($choice === null) {
            $this->output('error', sprintf('Invalid selection. Defaulting to %s/lang', 'webkernel/src/Aptitudes/I18n'));
        ...
        if ($choice === 'database') {
            ...
            $this->output('info', sprintf('Model: %s', '\\Webkernel\\Aptitudes\\I18n\\Models\\LanguageTranslation'));
