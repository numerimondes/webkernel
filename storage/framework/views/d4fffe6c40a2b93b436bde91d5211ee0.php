...
<section
    ...
    ?>
    style="background-image: url('<?php echo e(asset($firstImage)); ?>'); background-size: cover; background-position: center center;"
>
    ...
    >
        <?php $__currentLoopData = $sliderImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div
            ...
            >
                <img
                    src="<?php echo e(asset($slide['src'])); ?>"
    ...
    <div class="relative z-20 w-full px-4 py-16">
        ...
        <div class="mx-auto max-w-5xl w-full">
            <?php echo $__env->make('enjoy-the-world::software.body.01-1-hero-section-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
<?php if (! $__env->hasRenderedOnce('02018f33-9740-43ba-8cd9-88272d8697ae')): $__env->markAsRenderedOnce('02018f33-9740-43ba-8cd9-88272d8697ae'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/yassine/Documents/project/numerimondes-com/platform/EnjoyTheWorld/Resources/Views/software/body/01-0-hero-section.blade.php ENDPATH**/ ?>