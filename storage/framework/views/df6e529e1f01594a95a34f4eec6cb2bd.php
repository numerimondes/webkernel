<?php if ($__env->exists('base::filament.pages.documentation-hero-bg')) echo $__env->make('base::filament.pages.documentation-hero-bg', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="hero-content" style="max-width: 1200px; margin: 0 auto; position: relative;">
                ...
                <div
                    ...
                    <p style="font-weight: 600; color: white; margin: 0; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">
                        Common topics:</p>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $commonTopics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($topic['url']); ?>" class="card-hover"
                            ...
                            <div style="max-width: 1200px; margin: 0 auto;">
                                ...
                                <section style="margin-bottom: 3rem;">
                                    ...
                                    <div style="display: flex; flex-wrap: wrap; gap: 12px;">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e($article['url']); ?>" style="text-decoration: none;">
                                                <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['class' => '!p-1 !px-3 !text-sm !font-medium !rounded-full !shadow-none !border !border-gray-300 hover:!bg-primary-500 hover:!text-white transition-colors duration-200 card-hover']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => '!p-1 !px-3 !text-sm !font-medium !rounded-full !shadow-none !border !border-gray-300 hover:!bg-primary-500 hover:!text-white transition-colors duration-200 card-hover']); ?>
                                                            ...
                                                            <section class="collapsible-section top-sites"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <ul class="top-sites-list"
                                                                        style="display: grid; grid-template-columns: repeat(6, 1fr); gap: <?php echo e($minSpacing); ?>rem; row-gap: 1.5rem; list-style: none; padding: 0; margin: 0;">
                                                                        <?php
                                                                        ...
                                                                        ?>
                                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sortedSites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <?php
                                                                                $isFeatured =
                                                                                    isset($site['is_featured']) &&
                                                                                    $site['is_featured'];
                                                                            ...
                                                                            <li
                                                                                ...
                                                                                <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['class' => ''.e($sectionClass).'','style' => ''.e($sectionStyle).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => ''.e($sectionClass).'','style' => ''.e($sectionStyle).'']); ?>
                                                                                    <a href="<?php echo e($site['url']); ?>"
                                                                                        ...
                                                                                        <div class="top-site-icon rich-icon"
                                                                                            style="width: 48px; height: 48px; background-image: url('<?php echo e($imageUrl); ?>'); background-size: cover; background-position: center;">
                                                                                        </div>
                                                                                        <!--[if BLOCK]><![endif]--><?php if($isFeatured): ?>
                                                                                            <?php if (isset($component)) { $__componentOriginalbfc641e0710ce04e5fe02876ffc6f950 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbfc641e0710ce04e5fe02876ffc6f950 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.icon','data' => ['name' => 'heroicon-m-sparkles','class' => 'h-4 w-4','style' => 'position: absolute; top: 8px; right: 8px; color: #ffd700; z-index: 10;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'heroicon-m-sparkles','class' => 'h-4 w-4','style' => 'position: absolute; top: 8px; right: 8px; color: #ffd700; z-index: 10;']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                                                                <span
                                                                                    style="margin-top: 0.5rem; font-size: 0.875rem; text-align: center;"><?php echo e($site['title'] ?? 'Link Name'); ?></span>
                                                                            </li>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                                                    </ul>
                                                                </div>
                                ...
                                <section style="margin-bottom: 3rem;">
                                    ...
                                    <div
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['class' => 'card-hover']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'card-hover']); ?>
                                                <div
                                                ...
                                                <ul class="fi-dropdown-list max-h-60 overflow-y-auto fi-dropdown-list"
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $category['articles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                                ...
                                <section class="custom-gradient" style="margin-bottom: 3rem; border-radius: 16px; padding: 2rem; position: relative; overflow: hidden;">
                                    ...
                                    <div
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $popularArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e($article['url']); ?>" class="card-hover"
                                                style="text-decoration: none; display: flex;">
                                                <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['style' => '
...
<?php endif; ?>
                                ...
                                <section style="margin-bottom: 3rem;">
                                    ...
                                    <div
                                        style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['class' => 'card-hover']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
...
<?php $component->withAttributes(['class' => 'card-hover']); ?>
                                                <h3 style="margin: 0 0 8px 0;">
                                                    <a href="<?php echo e($activity['sectionUrl']); ?>"
                                                        style=" font-weight: 600; text-decoration: none;">
                                                        <?php echo e($activity['sectionTitle']); ?>

                                                    </a>
                                                </h3>
                                                <a href="<?php echo e($activity['articleUrl']); ?>"
                                                    style="display: block; margin-bottom: 12px; text-decoration: none;">
                                                    <?php echo e($activity['articleTitle']); ?>

                                                </a>
                                                <div
                                                    style="display: flex; align-items: center; justify-content: space-between; font-size: 12px;">
                                                    <div>Article created <?php echo e($activity['time']); ?></div>
                                                    <div style="display: flex; align-items: center; gap: 4px;">
                                                        ...
                                                        <span><?php echo e($activity['commentCount']); ?></span>
                                                    </div>
                                                </div>
                                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['class' => '','style' => 'border-radius: 16px; padding: 2rem; text-align: center;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => '','style' => 'border-radius: 16px; padding: 2rem; text-align: center;']); ?>
                                    <div
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['href' => '#','tag' => 'a']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '#','tag' => 'a']); ?>
                                        Contact us
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <div
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $footerCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['class' => 'card-hover','style' => 'border-radius: 12px;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'card-hover','style' => 'border-radius: 12px;']); ?>
                                            ...
                                            <a href="<?php echo e($card['url']); ?>"
                                                style="color: #8b5cf6; font-size: 14px; font-weight: 500; text-decoration: none;"><?php echo e($card['linkText']); ?></a>
                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalee08b1367eba38734199cf7829b1d1e9)): ?>
<?php $attributes = $__attributesOriginalee08b1367eba38734199cf7829b1d1e9; ?>
...
<?php endif; ?>
                        ...
                        <aside class="aside-content">
                            <?php if ($__env->exists('webkernel-users::widgets.app-store-card')) echo $__env->make('webkernel-users::widgets.app-store-card', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => ['style' => 'visibility: hidden;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'visibility: hidden;']); ?>
                                <div>
                                        ...
                                        <ul class="space-y-2">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <a href="<?php echo e($article['url']); ?>"
                                                        class="text-sm text-gray-600 hover:text-blue-600">
                                                        <?php echo e(Str::limit($article['text'], 40)); ?>
...
<?php /**PATH /home/yassine/Documents/project/numerimondes-com/webkernel/src/Aptitudes/Base/Resources/Views/filament/pages/documentation.blade.php ENDPATH**/ ?>