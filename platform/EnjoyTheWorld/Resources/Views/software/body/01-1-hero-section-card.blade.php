...
<div class="banner-form card mb-0">
                ...
                <li>
                    <a href="javascript:void(0);"
                       ...
                       data-bs-target="#{{ $tab['id'] }}">
                        <i class="isax isax-{{ $tab['icon'] }} me-2"></i>{{ $tab['label'] }}
                    </a>
                </li>
            @endforeach
        </ul>
    ...
    <div class="card-body">
        <div class="tab-content">
            <!-- Flight Tab -->
            <div class="tab-pane fade {{ $tabs[0]['active'] ? 'active show' : '' }}" id="{{ $tabs[0]['id'] }}">
                <form action="https://numerimondes.com/html/flight-grid.html">
                    <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                        <div class="d-flex align-items-center flex-wrap">
                            {!! renderRadioOptions($tripTypes, 'Radio') !!}
                        </div>
                    ...
                    <div class="normal-trip">
                        <div class="d-lg-flex">
                            <div class="d-flex form-info">
                                {!! renderLocationDropdown('From', 'Newyork', 'Ken International Airport', $locations, 'Search Location') !!}
                                {!! renderLocationDropdown('To', 'Las Vegas', 'Martini International Airport', $locations, 'Search Location', true) !!}
                                {!! renderDateInput('Departure', '07-09-2025', 'Sunday') !!}
                                <div class="form-item round-drip">
                                    {!! renderDateInput('Return', '23-10-2024', 'Wednesday') !!}
                                </div>
                                {!! renderTravelerDropdown('Travellers and cabin class', '4', '1 Adult, Economy', $travelerTypes, $cabinClasses) !!}
                            </div>
                    ...
                    <div class="multi-trip" style="display: none;">
                        <div class="d-lg-flex">
                            <div class="d-flex form-info">
                                {!! renderLocationDropdown('From', 'Newyork', 'Ken International Airport', $locations, 'Search Location') !!}
                                {!! renderLocationDropdown('To', 'Las Vegas', 'Martini International Airport', $locations, 'Search Location', true) !!}
                                {!! renderDateInput('Departure', '21-10-2024', 'Monday') !!}
                            </div>
                            <button type="submit" class="btn btn-primary search-btn rounded">Search</button>
                        </div>
                    </div>
            ...
            <!-- Hotels Tab -->
            <div class="tab-pane fade" id="{{ $tabs[1]['id'] }}">
                <form action="https://numerimondes.com/html/hotel-grid.html">
                    ...
                    <div class="d-lg-flex">
                        <div class="d-flex form-info">
                            {!! renderLocationDropdown('City, Property name or Location', 'Newyork', 'USA', $countries, 'Search for City, Property name or Location') !!}
                            {!! renderDateInput('Check In', '21-10-2025', 'Monday') !!}
                            {!! renderDateInput('Check Out', '21-10-2025', 'Monday') !!}
                            {!! renderTravelerDropdown('Guests', '4', '4 Adult, 2 Rooms', [['label' => 'Rooms', 'default' => 1], ['label' => 'Adults', 'default' => 2], ['label' => 'Childrens ( 2-12 Yrs )', 'default' => 0], ['label' => 'Infants ( 0-12 Yrs )', 'default' => 0]], $roomTypes, 'room') !!}
                            <div class="form-item dropdown">
                                <div data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
            ...
            <!-- Cars Tab -->
            <div class="tab-pane fade" id="{{ $tabs[2]['id'] }}">
                <form action="https://numerimondes.com/html/car-grid.html">
                    <div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
                        <div class="d-flex align-items-center flex-wrap">
                            {!! renderRadioOptions($dropOffTypes, 'drop') !!}
                        </div>
                        <h6 class="fw-medium fs-16 mb-2">Book Car for rental</h6>
                    </div>
                    <div class="d-lg-flex">
                        <div class="d-flex form-info">
                            {!! renderLocationDropdown('From', 'Newyork', 'USA', $carLocations, 'Search for Cars') !!}
                            {!! renderLocationDropdown('To', 'Newyork', 'USA', $carLocations, 'Search for Cars', true) !!}
                            {!! renderDateInput('Departure', '21-10-2024', 'Monday') !!}
                            <div class="form-item return-drop">
                                {!! renderDateInput('Return', '23-10-2024', 'Wednesday') !!}
                            </div>
                            {!! renderTimeInput('Pickup Time', '11:45 PM') !!}
                            {!! renderTimeInput('Dropoff Time', '11:45 PM') !!}
            ...
            <!-- Cruise Tab -->
            <div class="tab-pane fade" id="{{ $tabs[3]['id'] }}">
                <form action="https://numerimondes.com/html/cruise-grid.html">
                    ...
                    <div class="d-lg-flex">
                        <div class="d-flex form-info">
                            {!! renderLocationDropdown('Destination', 'Newyork', 'USA', $locations, 'Search Location') !!}
                            {!! renderDateInput('Start Date', '21-10-2025', 'Monday') !!}
                            {!! renderDateInput('End Date', '21-10-2025', 'Monday') !!}
                            {!! renderTravelerDropdown('Travellers & Cabin', '4', '4 Adult, 2 Rooms', $travelerTypes, $cabinTypes, 'cabin') !!}
                        </div>
                        <button type="submit" class="btn btn-primary search-btn rounded">Search</button>
                    </div>
                </form>
            ...
            <!-- Tour Tab -->
            <div class="tab-pane fade" id="{{ $tabs[4]['id'] }}">
                <form action="https://numerimondes.com/html/tour-grid.html">
                    ...
                    <div class="d-lg-flex">
                        <div class="d-flex form-info">
                            {!! renderLocationDropdown('Where would like to go?', 'Newyork', 'USA', $tourLocations, 'Search for City, Property name or Location') !!}
                            {!! renderDateInput('Dates', '21-10-2025', 'Monday') !!}
                            {!! renderDateInput('Check Out', '21-10-2025', 'Wednesday') !!}
                            {!! renderTravelerDropdown('Travellers', '4', '2 Adult', $travelerTypes) !!}
                        </div>
                        <button type="submit" class="btn btn-primary search-btn rounded">Search</button>
                    </div>
                </form>
